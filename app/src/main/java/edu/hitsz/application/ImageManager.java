...
public class ImageManager {
    ...
    static {
        try {
            ...
            ELITEPLUS_ENEMY_IMAGE = ImageIO.read(new FileInputStream("src/images/elite_plus.png"));
            ...
            PROP_BULLETPLUS_IMAGE = ImageIO.read(new FileInputStream("src/images/prop_bullet_plus.png"));
